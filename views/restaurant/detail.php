...
function submitReview() {
    ...
    fetch('/foodbooking/api/submit_rating.php', {
        method: 'POST',
...
function changeQty(itemId, delta) {
    ...
    fetch('/foodbooking/api/update_cart.php', {
        method: 'POST',
        headers: {'Content-Type': 'application/json'},
...
function clearCart() {
    ...
    fetch('/foodbooking/api/update_cart.php',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({action:'clear'})})
...
function saveVoucher(voucherId, btn) {
    btn.disabled = true;
    fetch('/foodbooking/api/save_voucher.php',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({voucher_id:voucherId})})
    .then(r=>r.json()).then(data=>{
        if(data.success){
            showToast('success',data.message);
